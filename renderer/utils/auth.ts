...
export const recoverStoredAuthSession = async (): Promise<AuthRecoveryResult> => {
...
export const clearAuthSession = async (
  setAuthData: Dispatch<SetStateAction<{ user: GithubUser; token: string } | null>> | ((data: { user: GithubUser; token: string } | null) => void),
) => {
