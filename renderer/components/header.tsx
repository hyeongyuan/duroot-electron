    ...
    >
      ...
      <div className="relative select-none" ref={elementRef}>
        ...
        <div
          ...
          className={`${isOpen ? '' : 'hidden'} z-10 bg-[#2d333b] border border-[#444c56] rounded-lg w-36 py-[4px] text-sm text-[#adbac7]`}
        >
          ...
          <Link href="/settings" className="flex items-center px-2 py-1 mx-2 hover:bg-[#444c56] rounded">
            <span className="mr-2">
          ...
          <a href="#" onClick={handleClickQuit} className="flex items-center px-2 py-1 mx-2 hover:bg-[#444c56] rounded">
            <span className="mr-2">
              <svg aria-hidden="true" focusable="false" viewBox="0 0 16 16" width="16" height="16" fill="#768390">
